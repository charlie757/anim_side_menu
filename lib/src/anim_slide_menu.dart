...
class AnimSlideSideMenuState extends SideMenuState {
  Duration animatedDuration;
  Curve curve;
  AnimSlideSideMenuState({this.animatedDuration = const Duration(milliseconds: 350),this.curve=Curves.fastLinearToSlowEaseIn});
  @override
