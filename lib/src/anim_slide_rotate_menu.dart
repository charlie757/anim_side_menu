// lib/src/shrink_slide_rotate_menu.dart

import 'package:flutter/material.dart';
import 'dart:math' show min;
import 'side_menu.dart'; // Import the base side menu file

class AnimSlideRotateSideMenuState extends SideMenuState {
  Duration animatedDuration;
  Curve curve;
  AnimSlideRotateSideMenuState({this.animatedDuration = const Duration(milliseconds: 350),this.curve=Curves.fastLinearToSlowEaseIn});
  @override
  ...
  Matrix4 _getMatrix4(Size size) {
    if (isOpened) {
      return Matrix4.identity()
        ..rotateZ(widget.degToRad(5.0 * widget.inverseValue))
        ..invertRotation()
        ..translate(
